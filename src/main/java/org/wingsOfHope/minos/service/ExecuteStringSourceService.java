...
public class ExecuteStringSourceService {
    ...
    public String execute(String source, String data) throws Exception {
        DiagnosticCollector<JavaFileObject> compileCollector = new DiagnosticCollector<>(); // 编译结果收集器

        // 编译源代码
        byte[] classBytes = StringSourceCodeCompiler.compile(source, compileCollector);
        ...
        Callable<String> runTask = new Callable<String>() {
            ...
            public String call() throws Exception {
                return JavaClassExecutor.execute(classBytes,data);
            }
        };
